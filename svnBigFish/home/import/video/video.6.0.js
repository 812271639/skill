...
var Component = function () {
  ...
  Component.prototype.addChild = function addChild(child) {
    ...
    if (typeof child === 'string') {
      ...
      // data stored directly on the video object may be
  ...
  Component.prototype.initChildren = function initChildren() {
    ...
    if (children) {
      ...
      var handleAdd = function handleAdd(child) {
        ...
        // e.g. video(id, { controlBar: false });
        // instead of video(id, { children: { controlBar: false });
  ...
  /**
   * Register a `Component` with `video` given the name and the component.
   *
   * > NOTE: {@link Tech}s should not be registered as a `Component`. {@link Tech}s
   *         should be registered using {@link Tech.registerTech} or
   *         {@link video:video.registerTech}.
   *
   * > NOTE: This function can also be seen on video as
   *         {@link video:video.registerComponent}.
   *
   * @param {string} name
   ...
   *
   * @deprecated In `video` 6 this will not return `Component`s that were not
   *             registered using {@link Component.registerComponent}. Currently we
   *             check the global `video` object for a `Component` name and
...
var _templateObject = _taggedTemplateLiteralLoose(['\n        Using the tech directly can be dangerous. I hope you know what you\'re doing.\n        See https://github.com/video/video.js/issues/2617 for more info.\n      '], ['\n        Using the tech directly can be dangerous. I hope you know what you\'re doing.\n        See https://github.com/video/video.js/issues/2617 for more info.\n      ']);
 ...
 * 1. By calling `video('example_video_1');`
 * 2. By using it directly via  `video.players.example_video_1;`
 *
 * @extends Component
 */
...
var Player = function (_Component) {
  ...
  Player.prototype.loadTech_ = function loadTech_(techName, source) {
    ...
    if (!TechClass) {
      throw new Error('No Tech named \'' + titleTechName + '\' exists! \'' + titleTechName + '\' should be registered using video.registerTech()\'');
    }
   ...
   *
   * ```js
   *   var myPlayer = video('some-player-id');
   *
   ...
   * Merge every time, because a newly added plugin might call video.addLanguage() at any time
...
var Html5 = function (_Tech) {
  ...
  /**
   * This will be triggered if the loadstart event has already fired, before video was
   * ready. Two known examples of when this can happen are:
   * 1. If we're loading the playback object after it has started loading
   * 2. The media is already playing the (often with autoplay on) then
   *
   * This function will fire another loadstart so that video can catchup.
   *
...
var Tech = function (_Component) {
  ...
  /**
   * Registers a `Tech` into a shared list for video.
   *
   * @param {string} name
  ...
  Tech.getTech = function getTech(name) {
    ...
    if (_window2['default'] && _window2['default'].videojs && _window2['default'].videojs[name]) {
      _log2['default'].warn('The ' + name + ' tech was added to the video object when it should be registered using video.registerTech(name, tech)');
...
},{"101":101,"102":102,"108":108,"49":49,"5":5,"77":77,"82":82,"88":88,"91":91,"92":92,"93":93,"95":95,"96":96}],65:[function(_dereq_,module,exports){
'use strict';
...
},{"102":102,"114":114,"69":69,"75":75,"78":78,"81":81,"88":88,"91":91,"92":92,"97":97}],75:[function(_dereq_,module,exports){
'use strict';
...
function fixEvent(event) {
  ...
  if (!event || !event.isPropagationStopped) {
    ...
    if (event.button !== null && event.button !== undefined) {
      ...
      // The following is disabled because it does not pass video-standard
      // and... yikes.
      /* eslint-disable */
 ...
 * The `video` function can be used to initialize or retrieve a player.
  *
...
/**
 * Add a function hook to a specific video lifecycle.
 *
 * @param {string} type
...
/**
 * Remove a hook from a specific video lifecycle.
 *
 * @param {string} type
 ...
 *
 * @borrows Component.getComponent as video.getComponent
 */
...
videojs.registerComponent = function (name, comp) {
  if (_tech2['default'].isTech(comp)) {
    _log2['default'].warn('The ' + name + ' tech was registered as a component. It should instead be registered using video.registerTech(name, tech)');
  }
 ...
 *
 * @borrows Tech.getTech as video.getTech
 */
 ...
 *
 * @borrows Tech.registerTech as video.registerTech
 */
 ...
 * compatibility with 4.x, but deprecated. Use `video.browser.TOUCH_ENABLED`
 ...
 *
 * @borrows extend:extendFn as video.extend
 */
 ...
 *
 * @borrows merge-options:mergeOptions as video.mergeOptions
 */
 ...
 * Register a Video.js plugin.
 *
 * @borrows plugin:registerPlugin as video.registerPlugin
 ...
 *
 * @deprecated
 *        video.plugin() is deprecated; use video.registerPlugin() instead
 *
 * @param {string} name
 *        The plugin name
 *
...
videojs.plugin = function (name, plugin) {
  _log2['default'].warn('videojs.plugin() is deprecated; use video.registerPlugin() instead');
 ...
 * Example: `video.addLanguage('es', { 'Hello': 'Hola' });`
 *
 * @param {string} code
 ...
 *
 * @borrows time-ranges:createTimeRanges as video.createTimeRange
 */
/**
 * @borrows time-ranges:createTimeRanges as video.createTimeRanges
 */
 ...
 *
 * @borrows format-time:formatTime as video.formatTime
 */
 ...
 * Resolve and parse the elements of a URL
 *
 * @borrows url:parseUrl as video.parseUrl
 */
 ...
 * Returns whether the url passed is a cross domain request or not.
 *
 * @borrows url:isCrossOrigin as video.isCrossOrigin
 */
 ...
 * Event target class.
 *
 * @borrows EventTarget as video.EventTarget
 */
 ...
 * Trigger a listener only once for an event
 *
 * @borrows events:one as video.one
 */
 ...
 * Removes event listeners from an element
 *
 * @borrows events:off as video.off
 */
 ...
 * Trigger an event for an element
 *
 * @borrows events:trigger as video.trigger
 */
 ...
 * TextTrack class
 *
 * @borrows TextTrack as video.TextTrack
 */
 ...
 *
 * @borrows AudioTrack as video.AudioTrack
 */
 ...
 *
 * @borrows VideoTrack as video.VideoTrack
 */
 ...
 * Determines, via duck typing, whether or not a value is a DOM element.
 *
 * @borrows dom:isEl as video.isEl
 * @deprecated Use video.dom.isEl() instead
 */

/**
 * Determines, via duck typing, whether or not a value is a text node.
 *
 * @borrows dom:isTextNode as video.isTextNode
 * @deprecated Use video.dom.isTextNode() instead
 */

/**
 * Creates an element and applies properties.
 *
 * @borrows dom:createEl as video.createEl
 * @deprecated Use video.dom.createEl() instead
 */

/**
 * Check if an element has a CSS class
 *
 * @borrows dom:hasElClass as video.hasClass
 * @deprecated Use video.dom.hasClass() instead
 */

/**
 * Add a CSS class name to an element
 *
 * @borrows dom:addElClass as video.addClass
 * @deprecated Use video.dom.addClass() instead
 */

/**
 * Remove a CSS class name from an element
 *
 * @borrows dom:removeElClass as video.removeClass
 * @deprecated Use video.dom.removeClass() instead
 */
 ...
 * condition or the presence/absence of the class name.
 *
 * @borrows dom:toggleElClass as video.toggleClass
 * @deprecated Use video.dom.toggleClass() instead
 */

/**
 * Apply attributes to an HTML element.
 *
 * @borrows dom:setElAttributes as video.setAttribute
 * @deprecated Use video.dom.setAttributes() instead
 */
 ...
 * This will return true or false for boolean attributes.
 *
 * @borrows dom:getElAttributes as video.getAttributes
 * @deprecated Use video.dom.getAttributes() instead
 */

/**
 * Empties the contents of an element.
 *
 * @borrows dom:emptyEl as video.emptyEl
 * @deprecated Use video.dom.emptyEl() instead
 */
 ...
 *   node, or array.
 *
 * @borrows dom:appendContents as video.appendContet
 * @deprecated Use video.dom.appendContent() instead
 */
 ...
 *   node, or array.
 *
 * @borrows dom:insertContent as video.insertContent
 * @deprecated Use video.dom.insertContent() instead
 */
['isEl', 'isTextNode', 'createEl', 'hasClass', 'addClass', 'removeClass', 'toggleClass', 'setAttributes', 'getAttributes', 'emptyEl', 'appendContent', 'insertContent'].forEach(function (k) {
  videojs[k] = function () {
    _log2['default'].warn('videojs.' + k + '() is deprecated; use video.dom.' + k + '() instead');
 ...
 *
 * @borrows computed-style:computedStyle as video.computedStyle
 */
...
},{"101":101,"102":102,"114":114,"45":45,"46":46,"5":5,"56":56,"57":57,"59":59,"63":63,"64":64,"66":66,"74":74,"80":80,"81":81,"83":83,"85":85,"86":86,"88":88,"89":89,"91":91,"92":92,"93":93,"94":94,"95":95,"97":97}],99:[function(_dereq_,module,exports){
...
var vttjs = module.exports = {
  WebVTT: _dereq_(109).WebVTT,
  VTTCue: _dereq_(110).VTTCue,
  VTTRegion: _dereq_(112).VTTRegion
};
...
},{"109":109,"110":110,"112":112}],109:[function(_dereq_,module,exports){
/**
 * Copyright 2013 vtt.js Contributors
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
if (typeof module !== "undefined" && module.exports) {
  this.VTTCue = this.VTTCue || _dereq_(111).VTTCue;
}
...
},{"111":111}],111:[function(_dereq_,module,exports){
/**
 * Copyright 2013 vtt.js Contributors
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
if (typeof module !== "undefined" && module.exports) {
  this.VTTRegion = _dereq_(113).VTTRegion;
}
...
},{"102":102,"103":103,"104":104,"115":115}],115:[function(_dereq_,module,exports){
