...
var Component = (function () {
  ...
  Component.getComponent = function getComponent(name) {
    ...
    if (_globalWindow2['default'] && _globalWindow2['default'].videojs && _globalWindow2['default'].videojs[name]) {
      _utilsLogJs2['default'].warn('The ' + name + ' component was added to the video object when it should be registered using video.registerComponent(name, component)');
  ...
  Component.extend = function extend(props) {
    ...
    _utilsLogJs2['default'].warn('Component.extend({}) has been deprecated, use video.extend(Component, {}) instead');
 ...
 * ```js
 * var Button = video.getComponent('Button');
 * ```
 * ```js
 * var MyButton = video.extend(Button, {
...
var Player = (function (_Component) {
  ...
  Player.prototype.tech = function tech(safety) {
    ...
    var errorText = '\n      Please make sure that you are not using this inside of a plugin.\n      To disable this alert and error, please pass in an object with\n      `IWillNotUseThisInPlugins` to the `tech` method. See\n      https://github.com/video/video.js/issues/2617 for more info.\n    ';
...
var Tech = (function (_Component) {
  ...
  Tech.getTech = function getTech(name) {
    ...
    if (_globalWindow2['default'] && _globalWindow2['default'].videojs && _globalWindow2['default'].videojs[name]) {
      _utilsLogJs2['default'].warn('The ' + name + ' tech was added to the video object when it should be registered using video.registerTech(name, tech)');
      return _globalWindow2['default'].videojs[name];
    }
  };
 ...
 * ```js
 *     var myPlayer = video('my_video_id');
 * ```
 *
...
var videojs = function videojs(id, options, ready) {
  ...
  if (!tag || !tag.nodeName) {
    ...
    throw new TypeError('The element or ID supplied is not valid. (video)'); // Returns
  }
...
videojs.players = _utilsCreateDeprecationProxyJs2['default'](_player2['default'].players, {
  get: 'Access to video.players is deprecated; use video.getPlayers instead',
  set: 'Modification of video.players is deprecated'
});

/**
 * Get a component class object by name
 * ```js
 *     var VjsButton = video.getComponent('Button');
 ...
 *     var MySpecialButton = video.extend(VjsButton, {});
...
videojs.registerComponent = function (name, comp) {
  if (_techTechJs2['default'].isTech(comp)) {
    _utilsLogJs2['default'].warn('The ' + name + ' tech was registered as a component. It should instead be registered using video.registerTech(name, tech)');
  }
 ...
 *     // get the Html5 Tech
 *     var Html5 = video.getTech('Html5');
 *     var MyTech = video.extend(Html5, {});
 *     // Register the new Tech
 *     VjsButton.registerTech('Tech', MyTech);
 *     var player = video('myplayer', {
 ...
 *     // when initializing
 *     var MySubClass = video.extend(MyClass, {
 ...
 *       }
 *     };
 *     var result = video.mergeOptions(defaultOptions, newOptions);
 *     // result.foo = false;
 *     // result.bar.a = true;
 *     // result.bar.b = [4,5,6];
 * ```
 ...
 *
 *     video.bind(newContext, function(){
 *       this === newContext
 *     });
 *
 ...
 * ```js
 *     video.addLanguage('es', { 'Hello': 'Hola' });
 * ```
 *
